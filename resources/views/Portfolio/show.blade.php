...
<body onload="page()" class="opacity-0 transition-all duration-500">
    <div class="flex flex-col h-fit min-h-screen lg:h-[100vh] w-full bg-[#F1F3F7]">

        <div class="p-8 h-[20px] w-[20px] fixed z-10">
            <a href=".">
                <i class="border-[#212427] border-b-[2px] border-l-[2px] inline-block w-[20px] h-[20px] p-3 rotate-[45deg] hover:border-b-[3px] hover:border-l-[3px]"></i>
            </a>
        </div>
        
        <div class="w-max h-fit ml-auto mr-auto pt-28 md:pb-28 sm:pb-28 max-sm:pb-28">
            <h1 class="text-6xl font-semibold">{{ $project->title }}</h1>
        </div>
